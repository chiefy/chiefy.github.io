		...
		function e() {
			...
			if (t.length) {
				for (var n = t[0].firstChild.childNodes, o = n.length; o--;) {
					var s = n[o],
						a = s.getAttribute("id").slice(-1),
						i = document.getElementById("fnref:" + a);
		...
		return _createClass(e, [{
			...
			value: function(e) {
				...
				document.body.addEventListener("click", function() {
					this.closeNote(e)
				}.bind(this)), t.innerHTML = e.getAttribute("data-note"), setTimeout(function() {
			...
			value: function(e, t, n) {
				var o = document.createElement("span"),
					s = e.firstChild.innerHTML,
					a = this;
				o.setAttribute("data-note", s), o.innerHTML = n, o.addEventListener("click", function(e) {
